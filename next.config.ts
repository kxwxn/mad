        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://ukcglqjdaqefddgqvmqf.supabase.co https://fzjfpmdz7ksfsins.public.blob.vercel-storage.com https://*.clerk.accounts.dev https://*.clerk.dev https://img.clerk.com https://images.clerk.dev",
              "font-src 'self' data:",
